...
rf, results_df = grid_search(RandomForestClassifier, parameters, 'random_forest')
...
grid_search(SVC, [parameters_linear,parameters_poly,parameters_rbf_sigmoid], 'svm', n_jobs=4)
